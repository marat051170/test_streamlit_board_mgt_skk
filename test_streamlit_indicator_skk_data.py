...
TEST_DIR = 'C:/Users/marat/OneDrive/Рабочий стол/tests/'

st.set_page_config(page_title='Запрет к эксплуатации', page_icon=':bar_chart:', layout='wide')
st.title('Данные СКК')
st.sidebar.header('Фильтры')

bans_data = pd.read_excel(f'{TEST_DIR}test_indicator_banned_for_exploitation.xlsx')
...
san_violation_data = pd.read_excel(f'{TEST_DIR}test_indicator_sanitary_condition_violations.xlsx')
